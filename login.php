...
<head>
    ...
    <title>Cuerpo de Bomberos del Cantón Flavio Alfaro</title>
    ...
    <div class="container">
        <div class="card card-container">
            ...
            <form method="post" accept-charset="utf-8" action="login.php" name="loginform" autocomplete="off" role="form"
                ...
                <button type="submit" class="btn btn-lg btn-danger btn-block btn-signin" name="login" id="submit">Iniciar
                    Sesión</button>
            </form>
        </div>
    </div>
